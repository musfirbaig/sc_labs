	 ...
	 public static Map<String, Set<String>> guessFollowsGraph(List<Tweet> tweets) {
	        ...
	        for (Tweet tweet : tweets) {
	            ...
	            for (String mentionedUser : mentionedUsers) {
	                graph.putIfAbsent(mentionedUser, new HashSet<>());
	                graph.get(mentionedUser).add(author);
	            }
	        }
	    ...
	    // The reachable function is not needed unless you require transitive relationships
